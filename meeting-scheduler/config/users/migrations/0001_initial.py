    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(choices=[('America/New_York', 'Eastern Time'), ('America/Chicago', 'Central Time'), ('America/Denver', 'Mountain Time'), ('America/Los_Angeles', 'Pacific Time'), ('Europe/London', 'UK Time'), ('UTC', 'UTC')], default='UTC', max_length=50)),
